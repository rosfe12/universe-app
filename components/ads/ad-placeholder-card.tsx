...
export function AdPlaceholderCard({
  ...
  return (
    <Card
      aria-label="광고"
      className={cn(
        "overflow-hidden border-amber-300/20 bg-[linear-gradient(180deg,rgba(17,24,39,0.98),rgba(15,23,42,0.98))] shadow-none",
        className,
      )}
    >
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="flex min-w-0 items-start gap-3">
            ...
            <div className="min-w-0 space-y-1">
              <div className="inline-flex items-center gap-1 rounded-full border border-amber-300/25 bg-amber-400/10 px-2.5 py-1 text-[11px] font-semibold text-amber-100">
          ...
          <Badge variant="outline" className="shrink-0 border-amber-300/25 bg-amber-400/10 text-amber-100">
            광고
          </Badge>
        </div>
        <div className="rounded-[18px] border border-amber-300/18 bg-amber-400/8 px-3 py-2 text-[12px] leading-5 text-amber-50/90">
          이 카드는 CAMVERSE 프로모션 광고입니다.
        </div>
