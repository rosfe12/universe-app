...
export function MobileTabBar() {
  ...
  return (
    <nav className="fixed bottom-[calc(env(safe-area-inset-bottom)+0.9rem)] left-1/2 z-50 w-[calc(100vw-1rem)] max-w-[440px] -translate-x-1/2 rounded-[30px] border border-white/10 bg-slate-950/96 px-2 py-2 shadow-[0_24px_60px_-30px_rgba(2,6,23,0.96)] backdrop-blur-xl">
