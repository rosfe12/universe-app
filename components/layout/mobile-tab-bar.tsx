...
export function MobileTabBar() {
  ...
  return (
    <nav className="fixed inset-x-2 bottom-[calc(env(safe-area-inset-bottom)+0.9rem)] z-50 rounded-[30px] border border-white/10 bg-slate-950/96 px-2 py-2 shadow-[0_24px_60px_-30px_rgba(2,6,23,0.96)] backdrop-blur-xl">
