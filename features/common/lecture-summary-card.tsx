    ...
    <Card className="group overflow-hidden border-white/85 bg-[linear-gradient(180deg,#fbfbff_0%,#ffffff_52%,#f6f7ff_100%)] transition-all duration-200 hover:-translate-y-1 hover:shadow-[0_26px_52px_-32px_rgba(79,70,229,0.26)]">
      <CardHeader className="space-y-4 pb-4">
        <div className="space-y-4">
          <div className="flex items-start justify-between gap-3">
            <div className="min-w-0 space-y-3">
              <div>
                ...
                <CardTitle className="mt-3 text-[22px] font-bold leading-8 text-balance">
                  {lecture.courseName}
                </CardTitle>
            ...
            <div className="shrink-0 rounded-[26px] border border-violet-100 bg-[linear-gradient(180deg,#eef2ff_0%,#ffffff_100%)] px-4 py-4 text-center text-violet-700 shadow-[0_22px_36px_-24px_rgba(99,102,241,0.45)]">
              <p className="whitespace-nowrap text-[10px] font-semibold tracking-[0.12em]">평균 점수</p>
              <p className="mt-1 text-[38px] font-bold leading-none">{lecture.averageHoneyScore.toFixed(1)}</p>
              <p className="mt-2 whitespace-nowrap text-[11px] leading-5 text-violet-700/70">
          ...
          <div className="min-w-0 space-y-3">
            <div>
              <div className="rounded-[24px] border border-indigo-100 bg-indigo-50/80 px-4 py-3.5 text-sm text-indigo-900">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {highlights.slice(0, 3).map((highlight) => (
                <Badge key={highlight} variant="outline" className="whitespace-nowrap">
                  {highlight}
                </Badge>
              ))}
            </div>
