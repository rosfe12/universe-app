...
const sections = [
  {
    title: "서비스 목적과 적용 범위",
    paragraphs: [
      "CAMVERSE (캠버스)는 대학생, 예비입학생, 입시생을 위한 학교 기반 커뮤니티 서비스입니다.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "CAMVERSE는 만 14세 이상 이용자를 대상으로 하며, 회원가입과 온보딩 과정에서 생년월일을 통해 이를 확인합니다. 이에 맞지 않는 가입은 제한될 수 있습니다.",
    ],
  },
  {
    title: "콘텐츠 게시와 운영",
  ...
  },
  {
    title: "탈퇴와 데이터 처리",
    paragraphs: [
      "회원은 언제든지 탈퇴를 요청할 수 있으며, 탈퇴 시 법령상 보관 의무가 있는 정보를 제외한 계정 정보와 활동 데이터는 지체 없이 삭제 또는 비식별 처리됩니다.",
      "운영상 필요한 경우 신고 기록, 제재 기록, 인증 심사 이력, 운영 로그와 최소 탈퇴 이력은 일정 기간 분리 보관될 수 있습니다.",
    ],
  },
  {
    title: "문의, 공지, 약관 변경",
  ...
  return (
    <div className="mx-auto flex min-h-screen max-w-3xl flex-col gap-6 px-5 py-10">
      ...
      <p className="text-sm text-muted-foreground">
        운영 및 권리침해 문의 <a href={`mailto:${supportEmail}`}>{supportEmail}</a> · 시행일 2026.03.29 ·{" "}
