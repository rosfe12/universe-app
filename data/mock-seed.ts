...
const admissionSeeds = [
  ...
  ["부동산학과 준비 중인데 건국대 학생부종합에서 수학 세특 중요할까요?", "대전", "문과", "내신 2.6", "부동산학과", 20, "경제/사회 쪽 활동은 많은데 수학 세특은 평이한 편입니다. 학과 특성상 어느 정도까지 챙겨야 하는지 궁금합니다.", "user-parent"],
  ["건국대 수의예과 논술 준비하는 학생들은 보통 어느 정도 성적대인가요?", "부산", "이과", "내신 1.7 / 수학 1", "수의예과", 29, "상향 카드로 고민 중인데 현실적인 지원선이 궁금합니다. 모의논술 체감도 같이 알고 싶어요.", "user-parent2"],
  ...
  ["건국대 생명계열 학과 준비 시 탐구 과목 선택이 많이 중요할까요?", "울산", "이과", "생명 1 / 지구 1", "동물자원과학과", 16, "생명계열 진학 희망인데 탐구 선택이 학교에서 권장하는 방향과 달라서 고민입니다.", "user-parent"],
  ["건국대 글로컬과 서울캠 전형 정보가 헷갈리는데 기준을 어떻게 봐야 하나요?", "전북", "문과", "내신 3.0", "행정학과", 14, "캠퍼스별 차이를 어떻게 이해해야 할지 모르겠습니다. 모집단위와 경쟁률 비교 팁 있으면 부탁드립니다.", "user-parent2"],
  ["건국대 창업 관련 학과나 비교과는 어디서 차별화가 되나요?", "서울", "문과", "내신 2.8", "경영학과", 19, "교내에서 창업 동아리를 하고 있는데 입시에서 이 활동을 어떻게 정리해야 할지 궁금합니다.", "user-sua"],
  ["건국대 교과전형은 내신 2점대 초반이면 어느 학과까지 노려볼 수 있을까요?", "경기", "문과", "내신 2.2", "정치외교학과", 21, "모의지원 사이트마다 결과가 달라서 감이 안 옵니다. 최근 입결 체감 공유 부탁드려요.", "user-parent"],
  ...
  ["건국대 부동산학과는 문과생이 지원하기에 어떤 준비가 가장 중요할까요?", "충남", "문과", "내신 2.7", "부동산학과", 17, "경제 기사 읽기와 통계 탐구를 하고 있는데 학과 적합성을 더 보여줄 방법이 있을까요?", "user-parent2"],
  ["건국대 논술은 인문계열에서도 수리논술 체감이 있나요?", "서울", "문과", "수학 3", "경영학과", 23, "문과라 수학이 약한 편인데 논술 준비할 때 수리 파트 비중이 어느 정도인지 궁금합니다.", "user-hajin"],
  ["건국대 입학 후 학교 분위기나 팀플 문화까지 고려하면 추천 학과가 있나요?", "경북", "문과", "내신 2.6", "경영학과", 12, "입시만이 아니라 실제 재학생 분위기도 함께 보고 싶습니다. 수업 분위기나 과제 문화 궁금해요.", "user-parent"],
